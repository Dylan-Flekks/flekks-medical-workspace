    ...
    pub(crate) async fn context_packet_create(
        ...
        let packet = state_db
            ...
            .prepare_context_packet(codex_state::WorkspaceContextPacketCreate {
                ...
                encounter_id: empty_to_none(params.encounter_id),
                note_id: empty_to_none(params.note_id),
                source_draft_session_id: params.source_draft_session_id,
                source_draft_checkpoint_id: params.source_draft_checkpoint_id,
                source_draft_checkpoint_revision: params.source_draft_checkpoint_revision,
                source_draft_checkpoint_sha256: params.source_draft_checkpoint_sha256,
...
fn api_workspace_context_packet_from_state(
    ...
    codex_app_server_protocol::WorkspaceContextPacket {
        ...
        encounter_id: value.encounter_id,
        note_id: value.note_id,
        source_draft_session_id: value.source_draft_session_id,
        source_draft_checkpoint_id: value.source_draft_checkpoint_id,
        source_draft_checkpoint_revision: value.source_draft_checkpoint_revision,
        source_draft_checkpoint_sha256: value.source_draft_checkpoint_sha256,
