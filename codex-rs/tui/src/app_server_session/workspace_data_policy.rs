//! Synthetic-only policy preflight for the local medical workspace.
...
mod tests {
    ...
    fn blocked_preflight_guidance_snapshot() {
        insta::assert_snapshot!(
            ...
            @r"
        local: medical workspace is unclassified and this process lacks synthetic provisioning authority; restart with `just medical-workspace` (no chart data was changed)
