...
mod tests {
    ...
    #[test]
    fn preserves_workflow_status_item_lifecycle_events() {
        let turn_id = "turn-1";
        let thread_id = ThreadId::new();
        let snapshot = codex_protocol::workflow::WorkflowSnapshot {
            id: "workflow-1".to_string(),
            title: "Regulated workflow".to_string(),
            state: codex_protocol::workflow::WorkflowStateKind::Running,
        ...
        let events = vec![
            ...
            EventMsg::ItemCompleted(codex_protocol::protocol::ItemCompletedEvent {
                thread_id,
                turn_id: turn_id.to_string(),
                item: codex_protocol::items::TurnItem::WorkflowStatus(
                    codex_protocol::items::WorkflowStatusItem {
                        id: "workflow-status-item".to_string(),
