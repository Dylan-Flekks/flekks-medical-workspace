...
client_request_definitions! {
    ...
    #[experimental("workspace/client/list")]
    WorkspaceClientList => "workspace/client/list" {
        params: v2::WorkspaceClientListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceClientListResponse,
    },
    #[experimental("workspace/client/get")]
    WorkspaceClientGet => "workspace/client/get" {
        params: v2::WorkspaceClientGetParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceClientGetResponse,
    },
    #[experimental("workspace/client/upsert")]
    WorkspaceClientUpsert => "workspace/client/upsert" {
        params: v2::WorkspaceClientUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspaceClientUpsertResponse,
    },
    #[experimental("workspace/client/archive")]
    WorkspaceClientArchive => "workspace/client/archive" {
    ...
    WorkspaceDocumentList => "workspace/document/list" {
        params: v2::WorkspaceDocumentListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceDocumentListResponse,
    },
    #[experimental("workspace/practice/library/list")]
    WorkspacePracticeLibraryList => "workspace/practice/library/list" {
        params: v2::WorkspacePracticeLibraryListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspacePracticeLibraryListResponse,
    },
    #[experimental("workspace/document/get")]
    WorkspaceDocumentGet => "workspace/document/get" {
        params: v2::WorkspaceDocumentGetParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceDocumentGetResponse,
    },
    #[experimental("workspace/document/upsert")]
    WorkspaceDocumentUpsert => "workspace/document/upsert" {
        params: v2::WorkspaceDocumentUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspaceDocumentUpsertResponse,
    },
    #[experimental("workspace/document/archive")]
    WorkspaceDocumentArchive => "workspace/document/archive" {
        params: v2::WorkspaceDocumentArchiveParams,
        serialization: global("workspace"),
        response: v2::WorkspaceDocumentArchiveResponse,
    },
    #[experimental("workspace/patient/safety/list")]
    WorkspacePatientSafetyItemList => "workspace/patient/safety/list" {
        params: v2::WorkspacePatientSafetyItemListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspacePatientSafetyItemListResponse,
    },
    #[experimental("workspace/patient/safety/upsert")]
    WorkspacePatientSafetyItemUpsert => "workspace/patient/safety/upsert" {
        params: v2::WorkspacePatientSafetyItemUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspacePatientSafetyItemUpsertResponse,
    },
    #[experimental("workspace/patient/safety/archive")]
    WorkspacePatientSafetyItemArchive => "workspace/patient/safety/archive" {
        params: v2::WorkspacePatientSafetyItemArchiveParams,
        serialization: global("workspace"),
        response: v2::WorkspacePatientSafetyItemArchiveResponse,
    },
    #[experimental("workspace/artifact/derivative/list")]
    WorkspaceArtifactDerivativeList => "workspace/artifact/derivative/list" {
        params: v2::WorkspaceArtifactDerivativeListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceArtifactDerivativeListResponse,
    },
    #[experimental("workspace/artifact/derivative/upsert")]
    WorkspaceArtifactDerivativeUpsert => "workspace/artifact/derivative/upsert" {
        params: v2::WorkspaceArtifactDerivativeUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspaceArtifactDerivativeUpsertResponse,
    },
    #[experimental("workspace/artifact/derivative/status/update")]
    WorkspaceArtifactDerivativeStatusUpdate => "workspace/artifact/derivative/status/update" {
        params: v2::WorkspaceArtifactDerivativeStatusUpdateParams,
        serialization: global("workspace"),
        response: v2::WorkspaceArtifactDerivativeStatusUpdateResponse,
    },
    #[experimental("workspace/context/clip/list")]
    WorkspaceContextClipList => "workspace/context/clip/list" {
        params: v2::WorkspaceContextClipListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceContextClipListResponse,
    },
    #[experimental("workspace/context/clip/upsert")]
    WorkspaceContextClipUpsert => "workspace/context/clip/upsert" {
        params: v2::WorkspaceContextClipUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspaceContextClipUpsertResponse,
    },
    #[experimental("workspace/context/clip/status/update")]
    WorkspaceContextClipStatusUpdate => "workspace/context/clip/status/update" {
        params: v2::WorkspaceContextClipStatusUpdateParams,
        serialization: global("workspace"),
        response: v2::WorkspaceContextClipStatusUpdateResponse,
    },
    #[experimental("workspace/task/list")]
    WorkspaceTaskList => "workspace/task/list" {
        params: v2::WorkspaceTaskListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceTaskListResponse,
    },
    #[experimental("workspace/task/upsert")]
    WorkspaceTaskUpsert => "workspace/task/upsert" {
        params: v2::WorkspaceTaskUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspaceTaskUpsertResponse,
    },
    #[experimental("workspace/task/status/update")]
    WorkspaceTaskStatusUpdate => "workspace/task/status/update" {
        params: v2::WorkspaceTaskStatusUpdateParams,
        serialization: global("workspace"),
        response: v2::WorkspaceTaskStatusUpdateResponse,
    },
    #[experimental("workspace/encounter/list")]
    WorkspaceEncounterList => "workspace/encounter/list" {
        params: v2::WorkspaceEncounterListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceEncounterListResponse,
    },
    #[experimental("workspace/encounter/upsert")]
    WorkspaceEncounterUpsert => "workspace/encounter/upsert" {
        params: v2::WorkspaceEncounterUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspaceEncounterUpsertResponse,
    },
    #[experimental("workspace/context/get")]
    WorkspaceContextGet => "workspace/context/get" {
        params: v2::WorkspaceContextGetParams,
        serialization: global_shared_read("workspace"),
    ...
    WorkspaceContextPacketList => "workspace/context/packet/list" {
        ...
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceContextPacketListResponse,
    },
    #[experimental("workspace/context/packet/create")]
    WorkspaceContextPacketCreate => "workspace/context/packet/create" {
        params: v2::WorkspaceContextPacketCreateParams,
        serialization: global("workspace"),
        response: v2::WorkspaceContextPacketCreateResponse,
    },
    #[experimental("workspace/context/packet/replay")]
    WorkspaceContextPacketReplay => "workspace/context/packet/replay" {
        params: v2::WorkspaceContextPacketReplayParams,
        serialization: global_shared_read("workspace"),
    ...
    WorkspaceAgentResultList => "workspace/agent/result/list" {
        ...
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceAgentResultListResponse,
    },
    #[experimental("workspace/agent/result/create")]
    WorkspaceAgentResultCreate => "workspace/agent/result/create" {
        params: v2::WorkspaceAgentResultCreateParams,
        serialization: global("workspace"),
        response: v2::WorkspaceAgentResultCreateResponse,
    },
    #[experimental("workspace/agent/result/status/update")]
    WorkspaceAgentResultStatusUpdate => "workspace/agent/result/status/update" {
    ...
    WorkspaceNoteList => "workspace/note/list" {
        params: v2::WorkspaceNoteListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceNoteListResponse,
    },
    #[experimental("workspace/note/get")]
    WorkspaceNoteGet => "workspace/note/get" {
        params: v2::WorkspaceNoteGetParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceNoteGetResponse,
    },
    #[experimental("workspace/note/upsert")]
    WorkspaceNoteUpsert => "workspace/note/upsert" {
        params: v2::WorkspaceNoteUpsertParams,
        serialization: global("workspace"),
        response: v2::WorkspaceNoteUpsertResponse,
    },
    #[experimental("workspace/note/archive")]
    WorkspaceNoteArchive => "workspace/note/archive" {
        params: v2::WorkspaceNoteArchiveParams,
        serialization: global("workspace"),
        response: v2::WorkspaceNoteArchiveResponse,
    },
    #[experimental("workspace/note/sign")]
    WorkspaceNoteSign => "workspace/note/sign" {
        params: v2::WorkspaceNoteSignParams,
        serialization: global("workspace"),
        response: v2::WorkspaceNoteSignResponse,
    },
    #[experimental("workspace/note/signature/list")]
    WorkspaceNoteSignatureList => "workspace/note/signature/list" {
        params: v2::WorkspaceNoteSignatureListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceNoteSignatureListResponse,
    },
    #[experimental("workspace/note/addendum/create")]
    WorkspaceNoteAddendumCreate => "workspace/note/addendum/create" {
        params: v2::WorkspaceNoteAddendumCreateParams,
        serialization: global("workspace"),
        response: v2::WorkspaceNoteAddendumCreateResponse,
    },
    #[experimental("workspace/note/addendum/list")]
    WorkspaceNoteAddendumList => "workspace/note/addendum/list" {
        params: v2::WorkspaceNoteAddendumListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceNoteAddendumListResponse,
    },
    #[experimental("workspace/note/proposal/list")]
    WorkspaceNoteProposalList => "workspace/note/proposal/list" {
        params: v2::WorkspaceNoteProposalListParams,
        serialization: global_shared_read("workspace"),
        response: v2::WorkspaceNoteProposalListResponse,
    },
    #[experimental("workspace/note/proposal/create")]
    WorkspaceNoteProposalCreate => "workspace/note/proposal/create" {
        params: v2::WorkspaceNoteProposalCreateParams,
        serialization: global("workspace"),
        response: v2::WorkspaceNoteProposalCreateResponse,
    },
    #[experimental("workspace/note/proposal/resolve")]
    WorkspaceNoteProposalResolve => "workspace/note/proposal/resolve" {
